...
public class TransactionEvent {
	 private Long transactionId;
		...
		public TransactionEvent(Long transactionId, Long accountId, String transactionType, Double amount,
		...
		public String toString() {
			return "TransactionEvent [transactionId=" + transactionId + ", accountId=" + accountId
